...
typedef enum
{
  ...
  /* LedBlinkNotify */
  CUSTOM_STM_LEDBLINKNOTIFY_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_LEDBLINKNOTIFY_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeBlinkled;
extern uint16_t SizeLedblinknotify;
